...
return {
	...
	["@jieming"] = "请指定【节命】的目标",
	["#QuhuNoWolf"] = "%from<font color='yellow'><b>【驱虎】</b></font>拼点成功，但是由于 %to 的攻击范围内没有目标，所以不能造成伤害",
	["#QuhuFightWolf"] = "%from 受<font color='yellow'><b>【驱虎】</b></font>影响攻击了 %to",
	["#QuhuFailed"] = "%from<font color='yellow'><b>【驱虎】</b></font>失败，受到了 %to 的攻击",
